...
namespace CustomAuth.Auth
{
    public class AuthMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            {
                var user = context.Users.FirstOrDefault(u => u.Email == username && u.Password == password & u.IsActive);
                return user != null;
            }
        }
        ...
        public override string GetUserNameByEmail(string email)
        {
            using (var context = new AppDbContext())
            {
                var username = context.Users.Where(u => u.Email == email).Select(u => u.Email).FirstOrDefault();
